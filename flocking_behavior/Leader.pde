class Leader {
  ...
  Leader (float xpos, float ypos, float radius, float rotationSatisfaction, float rotationDeceleration, float maxVelocity, 
      float maxAcceleration, float maxRotation, float maxAngular, float maxTime, float orientation, float wanderRate, color leaderColor) {
