/******************************************************************************
 * seek_steering
 * moves a character to the location of a mouse click 
 * by: Jason Suttles
 ******************************************************************************/
...
void setup() {
  ...
  // create new character (xpos, ypos, radiusSat, radiusDecel, maxVelocity, maxAcceleration, maxTime, orientation, orientationSteps)
  c = new Character(rCir*1.5, wSize-rCir*1.5, 2, 10, 10, 3, 3, 0, 3);
 ...
 */
void mousePressed() {
  targetX.append(mouseX);
  targetY.append(mouseY);
  loop();
}
